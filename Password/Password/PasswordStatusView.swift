...
class PasswordStatusView: UIView {
    ...
    let digitCharacterCriteriaView = PasswordCriteriaView(text: "digit (0-9)")
...
extension PasswordStatusView {
    ...
    func style() {
        ...
        digitCharacterCriteriaView.translatesAutoresizingMaskIntoConstraints = false
    ...
    func layout() {
        ...
        stackView.addArrangedSubview(digitCharacterCriteriaView)
